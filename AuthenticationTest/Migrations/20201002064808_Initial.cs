...
namespace StudentCompetitionHub.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Team_Staff_SupervisorEmail",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InvitedStudentEmail = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invite_Student_InvitedStudentEmail",
                        column: x => x.InvitedStudentEmail,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invite_InvitedStudentEmail",
                table: "Invite",
                column: "InvitedStudentEmail");

            migrationBuilder.CreateIndex(
                name: "IX_Invite_TeamId",
                table: "Invite",
                column: "TeamId");
